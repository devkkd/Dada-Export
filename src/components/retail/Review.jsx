...
const reviews = [
  ...
  return (
    <section className="w-full bg-[#FFF7F2] overflow-hidden pt-12 pb-20">
      <div className="max-w-[1600px] mx-auto px-8 md:px-12 lg:px-20 xl:px-24">
        ...
        <div className="flex flex-col items-left text-left mb-12 relative">
          <div className="flex items-center gap-3 mb-4">
            <div className="h-px w-18 bg-[#281000]"></div>
            <span className="text-[#281000] uppercase tracking-widest text-sm font-medium">
              WHAT PARTNERS SAY
            </span>
          </div>
          <h2 className="text-3xl md:text-4xl font-medium text-[#281000] mb-8">
            Trusted by Partners{' '}
            <span className="font-bold text-[#281000]">Worldwide</span>
          </h2>
        </div>
          ...
          <div className="overflow-hidden py-4 group">
            <div className="flex gap-4 sm:gap-5 md:gap-6 animate-marquee group-hover:[animation-play-state:paused]">
              {[...reviews, ...reviews].map((review, index) => (
                <div
                  key={index}
                  className="bg-[#FFF7F2] border border-[#E5D9C8] rounded-[16px] flex-shrink-0 flex flex-col justify-between transition-all duration-300 hover:-translate-y-2 hover:shadow-xl w-[220px] h-[240px] p-4 sm:w-[270px] sm:h-[260px] sm:p-5 md:w-[340px] md:h-[280px] md:p-6 lg:w-[400px] lg:h-[300px] lg:p-7 xl:w-[430px] xl:h-[300px] xl:p-8"
                >
                  {/* Stars */}
                  <div className="text-[#281000] tracking-[2px] sm:tracking-[3px] text-[11px] sm:text-[12px] md:text-sm mb-2 sm:mb-3 md:mb-4 lg:mb-6">
                    {review.stars}
                  </div>

                  {/* Review text — clamps to avoid overflow */}
