...
const filteredProducts =
  ...
  return (
    <section className="w-full bg-[#FFFEF9] py-16 md:py-20">
  ...
  <div className="flex items-center gap-4 mb-8">
    <div className="w-24 h-[1px] bg-[#95565E]"></div>

    <span className="text-[14px] tracking-wide uppercase text-[#95565E] font-medium">
      OUR PRODUCTS
    </span>
  </div>

  <h2 className="text-[52px] md:text-[64px] font-medium leading-none text-[#95565E]">
    New Arrival
  </h2>
</div>
    ...
    {cat}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredProducts.map((product) => (
            <div key={product.id} className="group bg-[#FFFEF9]   hover:shadow-xl transition-all duration-300">
...
<div className="flex items-center gap-3">
  ...
  className="px-10 py-4 bg-[#95565E] hover:bg-[#8A4F57] text-white rounded-full text-sm font-medium flex items-center gap-2 transition-colors"
>
  See All New Arrival →
</Link>
        </div>
