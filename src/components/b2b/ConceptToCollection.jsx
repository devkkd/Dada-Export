...
>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-3 items-center gap-6">
    ...
    <div className="flex items-center justify-center lg:justify-start gap-3">
      <div className="h-px w-12 bg-[#95565E]" />
      <span className="text-[#95565E] uppercase tracking-[3px] text-[11px] md:text-[12px] font-medium whitespace-nowrap">
        FOLLOW OUR JOURNEY
      </span>
    </div>
    ...
    <div className="flex justify-center lg:justify-end">
      ...
      >
        ...
        <div className="text-left">
          <p className="text-sm text-[#95565E] group-hover:underline">
            Follow Us on
          </p>
