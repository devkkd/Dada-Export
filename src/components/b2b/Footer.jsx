...
export default function Footer() {
  return (
    <footer className="bg-[#F9F4E1] text-[#3F2A1E] pt-12 pb-10">
  ...
  <div className="flex flex-col sm:flex-row gap-10 lg:gap-16">
    ...
    <div>
      <ul className="space-y-[10px] text-[12px]">
        ...
        <li><Link href="/b2b/about">About Us</Link></li>
        <li><Link href="/b2b/about">Why Choose</Link></li>
        <li><Link href="/b2b/process">Process</Link></li>
        <li><Link href="/b2b/wholesaleenquary">Wholesale Enquiry</Link></li>
...
<div className="mt-6 relative left-1/2 -translate-x-1/2 w-screen border-b border-[#3F2A1E]/10"></div>
        ...
        <div className="pt-0 mt-4 flex flex-col md:flex-row items-center justify-between gap-6 text-[14px]">
          ...
          <div className="text-center md:text-left">
            © 2025 Dada Exports, Pushkar. All Rights Reserved. Est. 1992 • Family Craft Since 1992.
          </div>
