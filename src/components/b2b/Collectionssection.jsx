...
export default function CollectionsSection() {
  return (
    <section className="w-full bg-[#FFFEF9] pt-16 sm:pt-20 md:pt-24 pb-4 sm:pb-6 md:pb-8">
      <div className="max-w-7xl mx-auto px-6">
        
        {/* Header */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-12 sm:mb-16">
          <div className="flex items-center gap-4">
            <div className="w-12 sm:w-16 h-px bg-[#95565E]"></div>
            <span className="text-xs sm:text-sm font-medium tracking-widest uppercase text-[#95565E]">
              BROWSE BY CATEGORY
            </span>
          </div>
