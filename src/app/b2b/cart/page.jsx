...
export default function CartPage() {
  ...
  return (
    <div className="bg-[#FFFEF9] min-h-screen">
     <div className="max-w-[1600px] mx-auto px-8 md:px-12 lg:px-20 xl:px-24 pt-12 pb-20">
        ...
        <h1 className="text-2xl md:text-3xl font-semibold text-black mb-10">
          Shopping Cart
        </h1>
          ...
          <>
            <div className="space-y-6">
              ...
              {items.map((item, index) => (
                <div
                  key={index}
             className="bg-white rounded-[28px] border border-[#E5D8CE] p-8 flex flex-col md:flex-row gap-8"
                >
                  {/* Product Image */}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 space-y-1 text-black/70 text-[13px] font-normal leading-4">
  <p>Size: {item.size}</p>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5 mt-6">
                      ...
                      <div className="flex items-center border border-[#CDBDB0] rounded-full overflow-hidden h-[48px] w-fit">
                        ...
                        <button
                          ...
                          className="w-12 h-12 flex items-center justify-center text-xl text-black"
                        >
                          −
                        </button>
  ...
  className="w-full mt-6 h-[58px] rounded-full bg-[#95565E] text-white font-semibold text-base md:text-lg hover:opacity-90 transition"
>
  Proceed To Payment
</button>
