...
const capabilities = [
  ...
  <div className="max-w-[1600px] mx-auto px-8 md:px-12 lg:px-20 xl:px-24 pt-12 pb-20">      {/* Header */}
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-medium text-[#95565E] leading-tight">
  ...
  <div>
    {steps.map((step, index) => (
      ...
      >
        ...
        <div>
          <h4
            className="text-[18px] md:text-[20px] font-semibold text-[#95565E] mb-2"
            style={{ fontFamily: 'Mona Sans, sans-serif' }}
          >
            {step.title}
          </h4>
  ...
  <h3
    className="text-[26px] md:text-[30px] font-medium text-[#95565E] mb-12"
    style={{ fontFamily: 'Mona Sans, sans-serif' }}
  >
