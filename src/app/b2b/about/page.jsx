...
import WhyChooseDadaExport from '@/components/b2b/WhyChooseDadaExports.jsx'
        ...
        <div className="min-h-screen bg-[#FFFEF9] font-sans">
           ...
           <div className="max-w-[1600px] mx-auto px-8 md:px-12 lg:px-20 xl:px-24 pt-12 pb-20">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-[#95565E] text-4xl font-medium tracking-tight mb-4" style={{ fontFamily: 'Mona Sans, sans-serif' }}>
                ...
                <div className="mb-24">
                    <h2
                        className="text-[#95565E] text-[26px] md:text-[30px] lg:text-[34px] font-semibold mb-10 md:mb-12"
                        style={{ fontFamily: 'Mona Sans, sans-serif' }}
                    >
                        Our Legacy & Story
                    </h2>
                ...
                <div className="bg-[#F9F4E1] rounded-2xl px-6 md:px-12 lg:px-16 py-10 md:py-14 mb-20 text-center border border-[#95565E]/10">
                    ...
                    <p
                        className="max-w-5xl mx-auto text-[#95565E] text-[20px] md:text-[22px] lg:text-[26px] leading-[160%] italic"
                        style={{
                    ...
                    <p
                        className="mt-8 md:mt-10 text-[#95565E] text-[17px] md:text-[20px] font-medium italic"
                ...
                <div className="py-10 md:py-16">
                    <h2
                        className="text-[#95565E] text-[28px] md:text-[34px] font-medium text-center mb-10 md:mb-16"
                        style={{ fontFamily: 'Mona Sans, sans-serif' }}
                    >
