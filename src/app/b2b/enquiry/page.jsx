...
<div className="flex-1">
    ...
    <h1 className="text-2xl md:text-3xl font-semibold text-[#0E0E0E] mb-3">
        {productInfo.title}
    </h1>

    <p className="text-sm text-[#3C2F2F] mb-6">
        {productInfo.subtitle}
    </p>

    <div className="space-y-2 text-[#0E0E0E]">
        ...
        <p>
            <b>Size :</b> {productInfo.size}
        </p>

        <p>
            <b>Print :</b> {productInfo.print}
        </p>

        <p>
            <b>Fabric :</b> {productInfo.fabric}
        </p>
...
Print : ${productInfo?.print}

Fabric : ${productInfo?.fabric}

Please share MOQ and quotation.`
